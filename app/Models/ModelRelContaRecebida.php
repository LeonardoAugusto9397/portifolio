...
class ModelRelContaRecebida {
    ...
    public function contaRecebida($Dados = null) {
        ...
        $listar->tRead("SELECT
                            ...
                            NEWTABLE.DESCRICAO,
                            NEWTABLE.VALOR_ACRESCIMO,
                            NEWTABLE.VALOR_DESCONTO,
                            ...
                            RF.DESCRICAO,
                            SUM(DFE.VALOR_ACRESCIMO) AS VALOR_ACRESCIMO,
                            SUM(DFE.VALOR_DESCONTO) AS VALOR_DESCONTO,
                        ...
                        WHERE (P.DATA_MOVIMENTO BETWEEN '$data_inicio' AND '$data_fim')
                            ...
                            AND CD.STATUS = 7
                        GROUP BY 1,2
                        ORDER BY DESCRICAO) AS NEWTABLE WHERE TIPO_DOCUMENTO IN('SAT','NFE','NFCE','PED','MFE')");
