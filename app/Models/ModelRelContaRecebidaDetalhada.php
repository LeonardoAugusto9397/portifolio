...
class ModelRelContaRecebidaDetalhada {
    ...
    public function contaRecebidaDetalhada($Dados = null) {
        ...
        $listar->tRead("SELECT DISTINCT
                            ...
                            DFE.VALOR_DESCONTO,
                            DFE.VALOR_LIQUIDO,
                            CAST(LIST(RF.DESCRICAO || ' - ' || CAST(CRD.VALOR_RECEBIDO AS DECIMAL(11, 2))) AS VARCHAR (8200)) AS RECEBIMENTO_FORMAS
