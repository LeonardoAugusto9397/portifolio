            ...
            <div class="row">
                <div class="col-6">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5 class="text-truncate">DOCUMENTOS FISCAIS</h5>
            ...
            <table class="table table-striped table-hover">
                <thead class="table-header">
                    <tr>
                        ...
                        <th class="text-center text-nowrap">CHAVE ACESSO</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center text-nowrap"><?php echo $CNPJ; ?></td>
                        <td class="text-center text-nowrap bg-light-blue"><?php echo $NUMERO_CFE; ?></td>
                        <td class="text-center text-nowrap"><?php echo $CHAVE_ACESSO; ?></td>
