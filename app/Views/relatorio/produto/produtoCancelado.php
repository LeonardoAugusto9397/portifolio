...
if (!empty($this->Dados['PEDIDO_EXCLUIDO'][0])) {
    extract($this->Dados['PEDIDO_EXCLUIDO'][0]);
    ...
    <div class="page-content">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5 class="text-truncate">PRODUTOS CANCELADO</h5>
        ...
        <div class="table-fixed" id="table-print">
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <?php foreach ($this->Dados['PEDIDO_EXCLUIDO'] as $cd) {
                        $tqtde  += $cd['QTDE'];
                        $ttotal += $cd['VALOR_TOTAL'];
                    extract($cd);
                    ?>
                    <tr>
                        <td class="text-nowrap text-center"><?php echo date('d/m/Y H:i:s', strtotime($DATA_HORA_EXCLUSAO)); ?></td>
                ...
                <tfoot class="table-footer">
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td class="text-nowrap text-right bg-info"><?php echo number_format($tqtde,0,",","."); ?></td>
