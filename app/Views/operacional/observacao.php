...
if (!empty($this->Dados['OBSERVACAO'][0])) {
    extract($this->Dados['OBSERVACAO'][0]);
?>
    ...
    <div class="page-content">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5 class="text-truncate">OBSERVAÇÕES</h5>
                        </div>
                    </div>
                </div>
				<div class="col-6">
        ...
        <div class="table-fixed">
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <?php foreach ($this->Dados['OBSERVACAO'] as $observacao) {
                    extract($observacao);
                    ?>
                    <!--<?php echo "<tr class='table-row' data-href='" . URL . "observacao/edit/$ID'>"; ?>-->
                    <tr>
